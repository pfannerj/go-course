...
func main() {
	...
	mapDelOK, _ := mapStore.DeletePuppy(mapPuppyID)
	fmt.Fprintf(mainout, "Map Puppy deleted: %t\n", mapDelOK)
	...
	syncDelOK, _ := syncStore.DeletePuppy(syncPuppyID)
	fmt.Fprintf(mainout, "Sync Puppy deleted: %t\n", syncDelOK)
}
